...
var cartReducer = Object(_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_3__["createReducer"])(initialState, Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, _actions_cart__WEBPACK_IMPORTED_MODULE_1__["ADD_TO_CART"], function (state, action) {
  ...
  if (state.items[addedProduct.productId]) {
    ...
    updatedOrNewCartItem = new _models_product__WEBPACK_IMPORTED_MODULE_2__["default"](prodId, prodPrice, prodName, state.items[addedProduct.productId].quantity + 1);
  } else {
    updatedOrNewCartItem = new _models_product__WEBPACK_IMPORTED_MODULE_2__["default"](prodId, prodPrice, prodName, 1);
  }

  return _objectSpread({}, state, {
    items: _objectSpread({}, state.items, Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, addedProduct.productId, updatedOrNewCartItem))
  });
}));
...
//# sourceMappingURL=index.js.327e094e2c254dbff6fb.hot-update.js.map