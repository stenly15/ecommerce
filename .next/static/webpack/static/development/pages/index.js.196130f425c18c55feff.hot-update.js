...
var cartReducer = Object(_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_3__["createReducer"])(initialState, Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, _actions_cart__WEBPACK_IMPORTED_MODULE_1__["ADD_TO_CART"], function (state, action) {
  var addedProduct = action.payload; // console.log(addedProduct)

  var updatedOrNewCartItem;

  if (state.items[addedProduct.id]) {
    // already have the item in the cart
    updatedOrNewCartItem = new _models_product__WEBPACK_IMPORTED_MODULE_2__["default"](state.items[addedProduct.id].quantity + 1, prodPrice, prodTitle, state.items[addedProduct.id].sum + prodPrice);
  } else {
...
//# sourceMappingURL=index.js.196130f425c18c55feff.hot-update.js.map